  ...
  return (
    <TileHeader className="w-fit">
      <TileLeft className="min-w-fit">
        ...
        <span className="text-c-50 text-[14px] w-[90px] shrink-0 font-medium">
          Party
        </span>
  ...
  return (
    <TileRow className="w-fit">
      <TileLeft className="min-w-fit">
        ...
        <div className="flex items-center gap-2 w-[90px] shrink-0">
          {data.party_logo && (
            <img
              src={data.party_logo}
              alt={data.party_short_name || "Party logo"}
              className="size-6 rounded-full object-cover shrink-0 bg-[#f2f2f2] border border-[#dfdfdf]"
            />
          )}
          <span className="text-[15px] text-c-80 truncate">
      ...
      <TileRight className="min-w-fit">
        ...
        <MarketingDropdown data={data} className="ml-2" />
      </TileRight>
    </TileRow>
  );
}
