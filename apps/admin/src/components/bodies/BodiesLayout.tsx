...
const TABS: Array<{ id: BodiesTabId; label: string; href: string }> = [
  ...
  { id: "federal-constituencies", label: "Federal Con.", href: "/bodies/federal-constituencies" },
  { id: "lgas", label: "LGAs", href: "/bodies/lgas" },
  { id: "state-constituencies", label: "State Con.", href: "/bodies/state-constituencies" },
  { id: "wards", label: "Wards", href: "/bodies/wards" },
  { id: "polling-units", label: "Polling units", href: "/bodies/polling-units" },
];

export function BodiesLayout({ title, activeTab, children }: BodiesLayoutProps) {
  return (
            ...
            {row.meta.map((item, index) => (
              <div
                ...
                className={cn(
                  ...
                  row.highlightLast && index === row.meta.length - 1 && "font-semibold",
                )}
              >
                {item}
              </div>
