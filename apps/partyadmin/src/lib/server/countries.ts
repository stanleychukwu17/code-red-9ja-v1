...
export const getSenatorialDistricts = createServerFn()
  ...
  .handler(async ({ data }) => {
    try {
      ...
      const response = await apiFetch(`${API_URL.getSenatorialDistricts}?${params.toString()}`);
...
export const getFederalConstituencies = createServerFn()
  ...
  .handler(async ({ data }) => {
    try {
      ...
      const response = await apiFetch(`${API_URL.getFederalConstituencies}?${params.toString()}`);
      const resData = await response.json();
      return resData;
    } catch (error) {
...
export const getStateConstituencies = createServerFn()
  ...
  .handler(async ({ data }) => {
    try {
      ...
      const response = await apiFetch(`${API_URL.getStateConstituencies}?${params.toString()}`);
      const resData = await response.json();
      return resData;
    } catch (error) {
