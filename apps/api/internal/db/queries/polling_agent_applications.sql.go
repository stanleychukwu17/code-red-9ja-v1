...
// versions:
//   sqlc v1.31.1
// source: polling_agent_applications.sql
...
func (q *Queries) CreateApplication(ctx context.Context, arg CreateApplicationParams) (PollingAgentApplication, error) {
...
func (q *Queries) GetApplicationByID(ctx context.Context, id int64) (PollingAgentApplication, error) {
...
func (q *Queries) UpdateApplicationStatus(ctx context.Context, arg UpdateApplicationStatusParams) (PollingAgentApplication, error) {
...
const updateUserRoleToAgent = `-- name: UpdateUserRoleToAgent :one
UPDATE users
SET
...
func (q *Queries) UpdateUserRoleToAgent(ctx context.Context, id int64) (User, error) {
	row := q.db.QueryRow(ctx, updateUserRoleToAgent, id)
	var i User
	err := row.Scan(
		&i.ID,
		&i.FakeID,
