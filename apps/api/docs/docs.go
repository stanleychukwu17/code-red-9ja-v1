...
const docTemplate = `{
        ...
        "/parties/{id}/allowances/settings": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "JSON mapping of state names to kobo payment amounts",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/paapplicationshandler.SubmitApplicationRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/paapplicationshandler.ApproveApplicationRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/paapplicationshandler.RejectApplicationRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "polling_unit_results.CandidateResultRequest": {
            "type": "object",
            "properties": {
                "candidate_id": {
                    "type": "integer"
        ...
        "polling_unit_results.SubmitResultRequest": {
            ...
            "properties": {
                ...
                "candidate_results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/polling_unit_results.CandidateResultRequest"
                    }
                },
                "election_group_id": {
                    "type": "integer"
