...
export function StateTableHeader() {
  return (
    <TileHeader>
      ...
      <TileRight>
        <span className="text-c-50 text-[14px] w-22.5 text-center hidden md:block">
          LGAs
        </span>
        <span className="text-c-50 text-[14px] w-22.5 text-center hidden md:block">
          Districts
        </span>
        <span className="text-c-50 text-[14px] w-22.5 text-center hidden lg:block">
          Federal Con.
        </span>
        <span className="text-c-50 text-[14px] w-22.5 text-center hidden lg:block">
          State Con.
        </span>
        <span className="text-c-50 text-[14px] w-22.5 text-center hidden sm:block">
          Wards
        </span>
...
export function StateTableTile({ data }: { data: StateType }) {
  return (
    <TileRow>
      ...
      <TileRight>
        <span className="text-[15px] text-c-70 w-22.5 text-center hidden md:block">
          {data.lgas_count ?? "-"}
        </span>
        <span className="text-[15px] text-c-70 w-22.5 text-center hidden md:block">
          {data.districts_count ?? "-"}
        </span>
        <span className="text-[15px] text-c-70 w-22.5 text-center hidden lg:block">
          {data.federal_constituencies_count ?? "-"}
        </span>
        <span className="text-[15px] text-c-70 w-22.5 text-center hidden lg:block">
          {data.state_constituencies_count ?? "-"}
        </span>
        <span className="text-[15px] text-c-70 w-22.5 text-center hidden sm:block">
          {data.wards_count ?? "-"}
        </span>
        <span className="text-[15px] text-c-80 w-22.5 text-center font-semibold">
