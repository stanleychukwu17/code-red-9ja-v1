  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 pb-12">
      ...
      <div className="w-full h-48 md:h-64 lg:h-80 relative overflow-hidden bg-neutral-200 dark:bg-neutral-800">
        <img
          src="https://images.unsplash.com/photo-1624383045192-cf512eb9d78c?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Party Cover"
        ...
        <div className="relative -mt-10 sm:-mt-10 mb-8 z-5">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-6 flex-1">
              ...
              <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-lg border-4 border-white dark:border-neutral-950 bg-white dark:bg-neutral-900 shadow-xl overflow-hidden shrink-0 relative z-10">
